...
namespace AStwoD.DAL.Entity_First_Model
{
    ...
    public partial class u380982_astwodEntities : ObjectContext
    {
        ...
        /// <param name="metaKeywords">No Metadata Documentation available.</param>
        /// <param name="metaDescription">No Metadata Documentation available.</param>
        /// <param name="publicationDate">No Metadata Documentation available.</param>
        /// <param name="isRemove">No Metadata Documentation available.</param>
    ...
    public partial class GetAllArticles_Result : ComplexObject
    {
        ...
        /// <summary>
        /// Create a new GetAllArticles_Result object.
        /// </summary>
        /// <param name="id">Initial value of the ID property.</param>
        /// <param name="publicationDate">Initial value of the PublicationDate property.</param>
    ...
    public partial class GetArticleByID_Result : ComplexObject
    {
        ...
        /// <summary>
        /// Create a new GetArticleByID_Result object.
        /// </summary>
        /// <param name="id">Initial value of the ID property.</param>
        /// <param name="publicationDate">Initial value of the PublicationDate property.</param>
    ...
    public partial class GetArticleByURL_Result : ComplexObject
    {
        ...
        /// <summary>
        /// Create a new GetArticleByURL_Result object.
        /// </summary>
        /// <param name="id">Initial value of the ID property.</param>
        /// <param name="uRL">Initial value of the URL property.</param>
        /// <param name="publicationDate">Initial value of the PublicationDate property.</param>
    ...
    public partial class GetRomovedPages_Result : ComplexObject
    {
        ...
        /// <summary>
        /// Create a new GetRomovedPages_Result object.
        /// </summary>
        /// <param name="id">Initial value of the ID property.</param>
        /// <param name="labelForURL">Initial value of the LabelForURL property.</param>
        /// <param name="isMenu">Initial value of the IsMenu property.</param>
